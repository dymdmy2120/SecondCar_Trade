		...
		<div id="w970" style="margin-left:185px;">
			...
			<div id="umain-nav" style="margin-bottom:5px;">
				...
				<ul class="list-u-menu">
					<li id="personInfo"><a href="user.html">个人信息</a>
					</li>
					<li id="renzheng"><a href="user/attest.html">实名认证</a>
					</li>
					<li id="alter"><a
						href="query/User/u_id=${sessionScope.user.u_id }">资料修改</a>
					</li>
					<li id="password"><a href="user/password.html">密码修改</a>
					</li>
			...
			<div id="umain-right" style="margin-bottom:5px;padding-top:2px;">
					...
					<table width="755" border="0" cellpadding="0" cellspacing="0">
						...
						<tbody>
							<tr>
								...
								<td width="150" height="25" align="center"><strong>竞价时间</strong>
								</td>
								<td width="100" height="25" align="center"><strong>竞价底价</strong>
								</td>
								<td width="160" height="25" align="center"><strong>当前状态</strong>
								</td>
							</tr>
							<c:forEach var="RegistrationVehicle" varStatus="st"
								items="${requestScope.list}">
								<tr style="border-bottom:solid 1px #c2d5e3;">
									<td>
										<div style="float:left;width:42%">
											<a href="vihicle-${RegistrationVehicle.v_id }.html"
												target="_blank"><img
												src="${RegistrationVehicle.imagePath}" style="display:block"
												border="0" height="90px" width=130px; /> </a>
											<!-- <td align="left" width="100"><a href="#" target="_blank"> -->
										</div>
										<div style="float:right;width:58%">
											<a style="font-size: 8px"
												href="vihicle-${RegistrationVehicle.v_id }.html"> <strong>${RegistrationVehicle.vname}</strong>
											</a>
											<ul style="font-size: 10px">
												<li>底价：<strong>${RegistrationVehicle.downprice}元</strong>
												</li>
												<li>保证金：<strong>${RegistrationVehicle.margin}元</strong>
												</li>
												<li>初次登记：<strong>${RegistrationVehicle.fristregist}</strong>
												</li>
											</ul>
										</div></td>
									<td>
										<div align="center">${RegistrationVehicle.biddingtime }
										</div></td>
									<td>
										<div
											style="font-weight:bold;font-size: 10px;text-align: center;"
											class="timeCss">${RegistrationVehicle.downprice}元</div></td>
									<td>
										<div align="center">${RegistrationVehicle.state}</div></td>
								</tr>
								<br />
							</c:forEach>
						</tbody>
				...
				<div align="center">
					<ul class="pagination">
						...
						<li><a
							href="query/RegistrationVehicle_${sessionScope.user.u_id }&skip=1">首页</a>
						</li>
						<li><a
							href="query/RegistrationVehicle_${sessionScope.user.u_id }&skip=${page.page-1<=1?1:page.page- 1}">
								上一页 </a>
						</li>
						<li><a
							href="query/RegistrationVehicle_${sessionScope.user.u_id }&skip=${page.page + 1 >=page.lastPage?page.lastPage:page.page + 1}">
								下一页</a>
						</li>
						<li><a
							href="query/RegistrationVehicle_${sessionScope.user.u_id }&skip=${page.lastPage}">
								末页</a>
						</li>
					</ul>
				</div>
