			...
			<div id="umain-right" style="margin-bottom:5px;padding-top:2px;">
				...
				<div
					...
					<table width="755" border="0" cellpadding="0" cellspacing="0">
						<tbody>
							<tr>
								<td width="310" align="center"><strong>竞价车辆</strong>
								</td>
								<td width="150" height="25" align="center"><strong>来源</strong>
								</td>
								<td width="160" height="25" align="center"><strong>本人出价</strong>
								</td>
							</tr>

							<c:forEach var="DealVehicle" varStatus="st"
								items="${requestScope.list}">
								<tr style="border-bottom:solid 1px #c2d5e3;">
									<td>
										<div style="float:left;width:42%">
											<a href="vihicle-${DealVehicle.v_id }.html" target="_blank"><img
												src="${DealVehicle.imagePath}" style="display:block"
												border="0" height="90px" width=130px; /> </a>
											<!-- <td align="left" width="100"><a href="#" target="_blank"> -->
										</div>
										<div style="float:right;width:58%">
											<a style="font-size: 8px"
												href="vihicle-${DealVehicle.v_id }.html"> <strong>${DealVehicle.vname}</strong>
											</a>
											<ul style="font-size: 10px">
												<li>底价：<strong>${DealVehicle.downprice}元</strong></li>
												<li>保证金：<strong>${DealVehicle.margin}元</strong></li>
												<li>初次登记：<strong>${DealVehicle.fristregist}</strong></li>
											</ul>
										</div>
									</td>
									<td>
										<div align="center">
											<img alt="中国人保浙江省分公司" src="${DealVehicle_v_source }" height="50"
												width="130" />
										</div>
									</td>
									<td>
										<div align="center">${DealVehicle.myprice}元</div>
									</td>
								</tr>
							</c:forEach>
						</tbody>
				...
				<div align="center">
					<ul class="pagination">
						...
						<li><a
							href="query/DealVehicle_${sessionScope.user.u_id }&skip=1">首页</a>
						</li>
						<li><a
							href="query/DealVehicle_${sessionScope.user.u_id }&skip=${page.page-1<=1?1:page.page- 1}">
								上一页 </a>
						</li>
						<li><a
							href="query/DealVehicle_${sessionScope.user.u_id }&skip=${page.page + 1 >=page.lastPage?page.lastPage:page.page + 1}">
								下一页</a>
						</li>
						<li><a
							href="query/DealVehicle_${sessionScope.user.u_id }&skip=${page.lastPage}">
								末页</a>
						</li>
					</ul>
				</div>
